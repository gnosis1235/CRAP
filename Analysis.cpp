...
void analysis(Root_file_handler * input_root_file, Root_file_handler * output_root_file, histo_handler * Hist, config_file_reader * config_file, __int64 num_events){
	...
	int buffersize = (int)parameter[1001];
	...
	for(__int64 idx=0;idx<num_events;idx++){
		...
		// this should always be first in the for loop
		input_root_file->get_next_event(event);	
		
		//set the number of hits recorded in the input rootfile
...
// Include your analysis here.
		...
		for(int i=1000; i<1000; ++i){
			Hist->fill1(101,"ehit_ntuple0",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(102,"ehit_ntuple1",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(103,"ehit_ntuple2",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(104,"ehit_ntuple3",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(105,"ehit_ntuple4",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(106,"ehit_ntuple5",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(107,"ehit_ntuple6",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(108,"ehit_ntuple7",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(109,"ehit_ntuple8",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(110,"ehit_ntuple9",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill2(111,"elec1xy_ntuple0",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(112,"elec1xy_ntuple1",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(113,"elec1xy_ntuple2",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(114,"elec1xy_ntuple3",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(115,"elec1xy_ntuple4",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(116,"elec1xy_ntuple5",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(117,"elec1xy_ntuple6",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(118,"elec1xy_ntuple7",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(119,"elec1xy_ntuple8",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(120,"elec1xy_ntuple9",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");


			Hist->fill1(201,"ehit_ntuple10",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(202,"ehit_ntuple11",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(203,"ehit_ntuple12",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(204,"ehit_ntuple13",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(205,"ehit_ntuple14",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(206,"ehit_ntuple15",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(207,"ehit_ntuple16",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(208,"ehit_ntuple17",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(209,"ehit_ntuple18",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(210,"ehit_ntuple19",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill2(211,"elec1xy_ntuple10",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(212,"elec1xy_ntuple11",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(213,"elec1xy_ntuple12",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(214,"elec1xy_ntuple13",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(215,"elec1xy_ntuple14",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(216,"elec1xy_ntuple15",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(217,"elec1xy_ntuple16",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(218,"elec1xy_ntuple17",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(219,"elec1xy_ntuple18",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(220,"elec1xy_ntuple19",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");

			Hist->fill1(301,"ehit_ntuple20",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(302,"ehit_ntuple21",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(303,"ehit_ntuple22",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(304,"ehit_ntuple23",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(305,"ehit_ntuple24",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(306,"ehit_ntuple25",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(307,"ehit_ntuple26",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(308,"ehit_ntuple27",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(309,"ehit_ntuple28",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(310,"ehit_ntuple29",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill2(311,"elec1xy_ntuple20",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(312,"elec1xy_ntuple21",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(313,"elec1xy_ntuple22",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(314,"elec1xy_ntuple23",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(315,"elec1xy_ntuple24",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(316,"elec1xy_ntuple25",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(317,"elec1xy_ntuple26",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(318,"elec1xy_ntuple27",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(319,"elec1xy_ntuple28",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(320,"elec1xy_ntuple29",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");


			Hist->fill1(401,"ehit_ntuple30",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(402,"ehit_ntuple31",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(403,"ehit_ntuple32",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(404,"ehit_ntuple33",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(405,"ehit_ntuple34",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(406,"ehit_ntuple35",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(407,"ehit_ntuple36",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(408,"ehit_ntuple37",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(409,"ehit_ntuple38",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill1(410,"ehit_ntuple39",event->e.num_hits,1.,"Electron hits (ntuple)",43,-1.25,20.25,"ehit","ntuple");
			Hist->fill2(411,"elec1xy_ntuple30",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(412,"elec1xy_ntuple31",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(413,"elec1xy_ntuple32",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(414,"elec1xy_ntuple33",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(415,"elec1xy_ntuple34",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(416,"elec1xy_ntuple35",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(417,"elec1xy_ntuple36",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(418,"elec1xy_ntuple37",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(419,"elec1xy_ntuple38",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
			Hist->fill2(420,"elec1xy_ntuple39",event->e.x[0],event->e.y[0],1.,"Electron position #1",400,-50,50,"e1x [mm]",400,-50,50,"e1y [mm]","ntuple");
		...
		if(writeNTuple) {
			...
			NTupleData[0] = double(event->reaction);
			NTupleData[1] = double(NElec);
			NTupleData[2] = double(NRec);
			NTupleData[3] = double(NPro);
			NTupleData[4] = event->bunchmarker;
			
			int absind = 5;

			for(int i=0;i<NRec;i++)
			{	// begin for: write all Recoils to NTuple
				NTupleData[absind+i*5] = double(event->r.x[i]);
				NTupleData[absind+i*5+1] = double(event->r.y[i]);
				NTupleData[absind+i*5+2] = double(event->r.time[i]);
				NTupleData[absind+i*5+3] = double(event->r.tof[i]);
				NTupleData[absind+i*5+4] = double(event->r.method[i]);
			}	// end for: write all Recoils to NTuple
			...
			for(int i=0;i<NElec;i++)
			{	// begin for: write all Electrons to NTuple
				NTupleData[absind+i*5] = double(event->e.x[i]);
				NTupleData[absind+i*5+1] = double(event->e.y[i]);
				NTupleData[absind+i*5+2] = double(event->e.time[i]);
				NTupleData[absind+i*5+3] = double(event->e.tof[i]);
				NTupleData[absind+i*5+4] = double(event->e.method[i]);
			}	// end for: write all Electrons to NTuple
			...
			for(int i=0;i<NPro;i++)
			{	// begin for: write all Projectiles to NTuple
				NTupleData[absind+i*5] = double(event->p.x[i]);
				NTupleData[absind+i*5+1] = double(event->p.y[i]);
				NTupleData[absind+i*5+2] = double(event->p.time[i]);
				NTupleData[absind+i*5+3] = double(event->p.tof[i]);
				NTupleData[absind+i*5+4] = double(event->p.method[i]);
			}	// end for: write all Projectiles to NTuple
